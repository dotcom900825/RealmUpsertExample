...
RCT_EXPORT_METHOD(exampleMethod)
{
  RLMRealm *realm = [RLMRealm defaultRealm];
    ...
    [realm transactionWithBlock:^{
      [realm addOrUpdateObject:[[Car alloc] initWithValue:@{@"id" : @2, @"miles" : @2000, @"make" : @"Nissan", @"model" : @"GTR"}]];
      Car *car = [[Car alloc] initWithValue:@{ @"id" : @2 }];
      [realm addOrUpdateObject:[[Person alloc] initWithValue:@{@"id" : @2, @"name" : @"test", @"birthday" : [NSDate dateWithTimeIntervalSinceNow:100], @"options" : @[@"123", @"456"], @"cars" : @[car]}]];
    }];
}
